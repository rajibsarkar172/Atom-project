...
class Welcome_base extends Frontend_Controller {
    ...
    public function index() {
        /* Get Slider Images */
        // $this->data['slides'] = $this->slider->get_by(['status' => 1]);

        /* Get Welcomenote */
        $this->data['welcomenote'] = $this->headercontent->get_by(['status' => 1]);
        //echo "<pre>"; print_r($this->data['welcomenote']); die;
        /* Load View */
        
        $this->data['slides'] = $this->slider->get_by(['status' => 1, 'type' => 'Home']);
        $this->data['welcomenote'] = $this->headercontent->get_by(['status' => 1]);
        $this->data['events'] = $this->services->get_by(['status' => 1]);
        //echo "<pre>"; print_r($this->data['events']); die;
    ...
    public function event($id) {
        ...
        $event_id = str_replace(array('?'), array('='), base64_decode($id));
        ...
        /* Load View */
        $this->data['subview'] = 'public/pages/events';
        $this->load->view('public/common/_layout_main', $this->data);
    }
    ...
    public function contact() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $this->session->set_flashdata('success', '<div class="alert alert-success">Send Email Successfully</div>');
            
        }


        $this->data['subview'] = 'public/pages/contact';
        $this->load->view('public/common/_layout_main', $this->data);
    }
